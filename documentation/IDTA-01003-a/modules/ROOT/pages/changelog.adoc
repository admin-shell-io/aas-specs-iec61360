...
* ADDED overview of constraints to Annex like in Part 1
* CHANGE remove mentioning of AML or OPC serialization, they are handled separately
* CHANGE section hierarchy and order
* CHANGE editorial changes
...
|===
h|nc h|V3.0.2 vs. V3.0.1 h| Changefootnote:[New, Update, Removed, Reformulated, Renamed] h|Comment
