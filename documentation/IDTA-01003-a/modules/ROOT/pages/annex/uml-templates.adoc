...
_ID_ is the metamodel ID of the class or attribute, conformant to the grammar defined in link:  xref:mappings/mappings.adoc#reference-serialization[Text Serialization of Values of Type "Reference"].
