...
_ID_ is the metamodel ID of the class or attribute, conformant to the grammar defined in Part 1 Metamodel, IDTA-01001.
...
If class type equal to "ModelReference<Submodel>", the following reference would be a valid reference (using the text serialization as defined in Part 1 Metamodel, IDTA-01001):
